...
namespace Unclassified.Util
{
	...
	public class CommandLineReader
	{
		...
		/// <summary>
		/// Initialises a new instance of the <see cref="CommandLineReader"/> class.
		/// </summary>
		...
		public CommandLineOption RegisterOption(string name)
		{
		...
		public void Parse()
		{
			...
			foreach (string arg in aw)
			{
				...
				else if (optMode && (arg.StartsWith("/") || arg.StartsWith("-")))
				{
					...
					var argument = new CommandLineArgument(option, values);
				...
				{
					parsedArguments.Add(new CommandLineArgument(null, new[] { arg }));
				}
			}
		...
		/// exception handling.
		/// </remarks>
		public CommandLineOption[] SetOptions
		{
			get
			{
				if (parsedArguments == null)
	...
	#region Classes for options and arguments
	...
	{
		/// <summary>
		/// Initialises a new instance of the <see cref="CommandLineOption"/> class.
		/// </summary>
		/// <param name="name">The primary name of the option.</param>
		/// <param name="parameterCount">The number of additional parameters for this option.</param>
		internal CommandLineOption(string name, int parameterCount)
		{
		...
		/// </summary>
		public Action<CommandLineArgument> Action { get; private set; }
		...
		/// for this option.
		/// </summary>
		public CommandLineArgument Argument { get; internal set; }
		...
		/// <returns>The current <see cref="CommandLineOption"/> instance.</returns>
		public CommandLineOption Alias(params string[] names)
		{
		...
		/// </summary>
		/// <returns>The current <see cref="CommandLineOption"/> instance.</returns>
		public CommandLineOption Single()
		{
			this.IsSingle = true;
			return this;
		}
		...
		/// <returns>The current <see cref="CommandLineOption"/> instance.</returns>
		public CommandLineOption Do(Action<CommandLineArgument> action)
		{
			this.Action = action;
			return this;
		}
	...
	#endregion Classes for options and arguments
}

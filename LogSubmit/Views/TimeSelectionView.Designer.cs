namespace Unclassified.LogSubmit.Views
{
	partial class TimeSelectionView
	{
		...
		private void InitializeComponent()
		{
			...
			this.TitleLabel.Size = new System.Drawing.Size(133, 18);
			this.TitleLabel.TabIndex = 0;
			this.TitleLabel.Text = "[time selection.title]";
			// 
			// label1
			// 
			...
			this.label1.Text = "[time selection.intro]";
			// 
			// label2
			// 
			...
			this.label2.Text = "[time selection.last log update time]";
			// 
			// LastUpdateTimeLabel
			// 
			this.LastUpdateTimeLabel.AutoSize = true;
			this.LastUpdateTimeLabel.Location = new System.Drawing.Point(187, 119);
			...
			this.label3.Text = "[time selection.latest submit start time]";
			// 
			// LogMinTimeLabel
			// 
			this.LogMinTimeLabel.AutoSize = true;
			this.LogMinTimeLabel.Location = new System.Drawing.Point(187, 138);
			...
			this.label4.Text = "[time selection.note]";
			// 
			// TimeTrackBar
			// 
			...
			this.TimeTrackBar.Location = new System.Drawing.Point(0, 70);
			...
			this.WebLinkLabel.Location = new System.Drawing.Point(0, 190);
			this.WebLinkLabel.Margin = new System.Windows.Forms.Padding(0, 6, 0, 0);
			this.WebLinkLabel.Name = "WebLinkLabel";
			this.WebLinkLabel.Size = new System.Drawing.Size(129, 13);
			this.WebLinkLabel.TabIndex = 11;
			this.WebLinkLabel.TabStop = true;
			this.WebLinkLabel.Text = "[time selection.learn more]";

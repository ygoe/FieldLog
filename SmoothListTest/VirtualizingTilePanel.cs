...
namespace SmoothListTest
{
	public class VirtualizingTilePanel : VirtualizingPanel, IScrollInfo
	{
		...
		public static readonly DependencyProperty ChildDimensionProperty
			= DependencyProperty.Register("ChildDimension", typeof (Size), typeof (VirtualizingTilePanel),
												  new FrameworkPropertyMetadata(new Size(200,200),
		...
		public Size ChildDimension
		{
			get { return (Size) GetValue(ChildDimensionProperty); }
			set { SetValue(ChildDimensionProperty,value); }
		}
		/// <summary>
		...
		private Size CalculateExtent(Size availableSize, int itemCount)
		{
			...
			// See how big we are
			return new Size(childrenPerRow * this.ChildDimension.Width,
				this.ChildDimension.Height * Math.Ceiling((double)itemCount / childrenPerRow));
		}
		...
		private void GetVisibleRange(out int firstVisibleItemIndex, out int lastVisibleItemIndex)
		{
			...
			firstVisibleItemIndex = (int) Math.Floor(_offset.Y / this.ChildDimension.Width) * childrenPerRow;
			lastVisibleItemIndex = (int) Math.Ceiling((_offset.Y + _viewport.Height) / this.ChildDimension.Height) * childrenPerRow - 1;
		...
		private void ArrangeChild(int itemIndex, UIElement child, Size finalSize)
		{
			...
			child.Arrange(new Rect(column * this.ChildDimension.Width, row * this.ChildDimension.Height, this.ChildDimension.Width, this.ChildDimension.Height));
		}
		...
		private int CalculateChildrenPerRow(Size availableSize)
		{
			...
			return double.IsPositiveInfinity(availableSize.Width) ? this.Children.Count : Math.Max(1, (int)Math.Floor(availableSize.Width / this.ChildDimension.Width));
		}
